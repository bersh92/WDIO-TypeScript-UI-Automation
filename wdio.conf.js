const config = require('./config').parseArgs(process.argv);
const windowSize = '1920,1080';
const instances = config.headless ? 3 : 1;
...
exports.config = {
    ...
    suites: {
        click_on_buttons_from_bottom_menu: ['wdio/specs/clickOnButtonsFromBottomMenu.ts'],
        click_on_buttons_from_header: ['wdio/specs/clickOnButtonsFromHeader.ts']
    },
    // Patterns to exclude.
    exclude: [
    ...
    capabilities: [{
        maxInstances: instances,
        browserName: 'chrome',
        //  ADD CHROME OPTIONS FOR HEADLESS MODE
        'goog:chromeOptions': {
